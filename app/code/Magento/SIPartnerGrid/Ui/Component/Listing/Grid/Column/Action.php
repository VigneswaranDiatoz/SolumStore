...
namespace Magento\SIPartnerGrid\Ui\Component\Listing\Grid\Column;
...
{
    /** Url path */
    const ROW_EDIT_URL = 'sipartnergrid/grid/addrow/';
    const ROW_STATUS_URL = 'sipartnergrid/grid/changestatus/';
    /** @var UrlInterface */
